...
/***
 * TODO
 * Add score to the DOM in the header
 * Create an intro Modal, explain rules -- make the mole go away
 * Create a Loose moment -- maybe not since it can go on forever
 * Add an animation when the mole gets clicked
 * Add an animation for click and miss, also maybe subtract a point
 * Multiply and shrink the mole when clicked
